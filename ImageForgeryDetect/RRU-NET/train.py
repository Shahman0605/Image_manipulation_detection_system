...
if __name__ == '__main__':
    ...
    dir_img = '/content/drive/MyDrive/Image_detection_system/Data/traindev/spliced/images'.format(dataset)
    dir_mask = '/content/drive/MyDrive/Image_detection_system/Data/traindev/spliced/Train_Spliced_masks'.format(dataset)
    dir_logs = '/content/drive/MyDrive/Image_detection_system/Environments/RRU-NET/results/logs'.format(dataset, model)
    ...
    if ft:
        fine_tuning_model = '/content/drive/MyDrive/Image_detection_system/Environments/RRU-NET/results/logs/test.pkl'.format(dataset, model)
